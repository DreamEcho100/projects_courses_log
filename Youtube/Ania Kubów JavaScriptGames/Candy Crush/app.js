document.addEventListener("DOMContentLoaded", () => {
	...
	// squares.forEach((square) => square.addEventListener(, ));
	const squareActions = [
		{event: "dragstart", function: dragStart, bubbles: false}, 
		// {event: "touchstart", function: dragStart, bubbles: false}, 
		{event: "dragover", function: dragOver, bubbles: false}, 
		// {event: "touch", function: , bubbles: false}, 
		{event: "dragenter", function: dragEnter, bubbles: false}, 
		// {event: "touch", function: , bubbles: false}, 
		{event: "dragleave", function: dragLeave, bubbles: false}, 
		// {event: "touch", function: , bubbles: false}, 
		{event: "drop", function: dragDrop, bubbles: false}, 
		// {event: "touchmove", function: dragDrop, bubbles: false}, 
		{event: "dragend", function: dragEnd, bubbles: false},  
		// {event: "touchend", function: dragEnd, bubbles: false},  
		{event: "pointerdown", function: pointerDown, bubbles: false}, 
		// {event: "pointermove", function: pointerMove, bubbles: false}, 
		{event: "pointerhold", function: pointerDown, bubbles: false}, 
		{event: "pointerup", function: pointerUp, bubbles: false}, 
	]

	squareActions.forEach(squareAction => {
		squares.forEach((square) => square.addEventListener(squareAction.event, squareAction.function, squareAction.bubbles));
	});
