...
*/
/*
https://www.codegrepper.com/code-examples/javascript/convert+raw+png+to+base64+js
...
const randompngImagesBase64 =
	pngImagesBase64[Math.floor(Math.random() * pngImagesBase64.size)];
const png = new Image();
